...
#fit.save_csvfiles(dir="stan_model/mcmc_output/gpt2_norm")

start_time = time.time()
model_fit = arviz.from_cmdstanpy(fit)
print((time.time() - start_time), 's')

savepath = 'stan_model/model_fit/gpt2_norm/exp_combined_{model_name}_model_fit.nc'.format(model_name=model_name)
